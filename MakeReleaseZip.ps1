...
# Source paths
$AssemblyInfoPath = ".\ParameterValidationUniversal\Properties\AssemblyInfo.cs"
$UniversalAnyPath = ".\ParameterValidationUniversal\bin\Release"
$UniversalARMPath = ".\ParameterValidationUniversal\bin\ARM\Release"
$Universalx86Path = ".\ParameterValidationUniversal\bin\x86\Release"
$Universalx64Path = ".\ParameterValidationUniversal\bin\x64\Release"
$DesktopPath = ".\ParameterValidationDesktop\bin\Release\"
...
Get-Content $AssemblyInfoPath | ForEach-Object {
	if ($_ -match "AssemblyInformationalVersion") {
		...
		$OutputFile = $OutputPath + "NerdyDuck.ParameterValidation_" + $_.SubString($StartPos, $Length) + ".zip"
	}
}
