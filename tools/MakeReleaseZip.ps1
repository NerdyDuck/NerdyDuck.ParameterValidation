...
# Creates a zip file from the release folders of the ParameterValidationDesktop and
# ParameterValidationUniversal projects, versioning the file using the
...
# Source paths
$AssemblyInfoPath = "..\src\ParameterValidationUniversal\Properties\AssemblyInfo.cs"
$UniversalAnyPath = "..\src\ParameterValidationUniversal\bin\Release"
$UniversalARMPath = "..\src\ParameterValidationUniversal\bin\ARM\Release"
$Universalx86Path = "..\src\ParameterValidationUniversal\bin\x86\Release"
$Universalx64Path = "..\src\ParameterValidationUniversal\bin\x64\Release"
$DesktopPath = "..\src\ParameterValidationDesktop\bin\Release\"
...
Get-Content $AssemblyInfoPath | ForEach-Object {
	if ($_ -match "AssemblyVersion") {
		...
		$OutputFile = $OutputPath + "NerdyDuck.ParameterValidation_" + $FileVer.ToString(3) + ".zip"
	}
}
