...
namespace NerdyDuck.ParameterValidation
{
	...
	public class InvalidDataTypeException : CodedFormatException
	{
		...
		public InvalidDataTypeException()
			: base(Properties.Resources.InvalidDataTypeException_Message)
		{
			mConstraint = null;
		}
		...
		public InvalidDataTypeException(int hresult)
			: base(hresult, Properties.Resources.InvalidDataTypeException_Message)
		{
			mConstraint = null;
		}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="InvalidDataTypeException"/> class with a specified HRESULT value and constraint.
		/// </summary>
		/// <param name="hresult">The HRESULT that describes the error.</param>
		...
		/// <para>See the <a href="http://msdn.microsoft.com/en-us/library/cc231198.aspx">HRESULT definition at MSDN</a> for
		/// more information about the definition of HRESULT values.</para></remarks>
		public InvalidDataTypeException(int hresult, Constraint constraint)
			: base(hresult, Properties.Resources.InvalidDataTypeException_Message)
		{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="InvalidDataTypeException"/> class with a specified HRESULT value, error message and constraint.
		/// </summary>
		/// <param name="hresult">The HRESULT that describes the error.</param>
		/// <param name="message">The message that describes the error.</param>
		/// <param name="constraint">The constraint that caused the exception.</param>
		...
		/// <para>See the <a href="http://msdn.microsoft.com/en-us/library/cc231198.aspx">HRESULT definition at MSDN</a> for
		/// more information about the definition of HRESULT values.</para></remarks>
		public InvalidDataTypeException(int hresult, string message, Constraint constraint)
			: base(hresult, message)
		{
			mConstraint = constraint;
		}
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="InvalidDataTypeException"/> class with a specified HRESULT value, error message, constraint and a reference to the inner exception that is the cause of this exception.
		/// </summary>
		/// <param name="hresult">The HRESULT that describes the error.</param>
		/// <param name="message">The message that describes the error.</param>
		/// <param name="constraint">The constraint that caused the exception.</param>
		...
		/// <para>See the <a href="http://msdn.microsoft.com/en-us/library/cc231198.aspx">HRESULT definition at MSDN</a> for
		/// more information about the definition of HRESULT values.</para></remarks>
		public InvalidDataTypeException(int hresult, string message, Constraint constraint, Exception innerException)
			: base(hresult, message, innerException)
		{
			mConstraint = constraint;
		}
