...
namespace NerdyDuck.ParameterValidation.Constraints
{
	...
	public class FileNameConstraint : Constraint
	{
		...
		protected override void OnValidation(IList<ParameterValidationResult> results, object value, ParameterDataType dataType, string memberName, string displayName)
		{
			...
			{
				results.Add(new ParameterValidationResult(Errors.CreateHResult(0x07), Properties.Resources.Global_Validate_StringEmpty, this));
			}
			else if (Temp.IndexOfAny(Path.GetInvalidFileNameChars()) > -1)
			{
				results.Add(new ParameterValidationResult(Errors.CreateHResult(0x08), string.Format(Properties.Resources.FileNameConstraint_Validate_Failed, Temp), this));
			}
		}
		#endregion
		#endregion
