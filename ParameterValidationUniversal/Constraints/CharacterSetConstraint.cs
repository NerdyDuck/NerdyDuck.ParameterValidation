...
namespace NerdyDuck.ParameterValidation.Constraints
{
	...
	public class CharacterSetConstraint : Constraint
	{
		...
		public enum CharSet
		{
			...
			,
			/// <summary>
			/// The subset of ISO 646-IRV (ASCII) used for string in OFTP, e.g. virtual file names.
			/// </summary>
			Iso646Odette = 3
#endif
		}
		...
		protected override void OnValidation(IList<ParameterValidationResult> results, object value, ParameterDataType dataType, string memberName, string displayName)
		{
			...
			{
				results.Add(new ParameterValidationResult(Errors.CreateHResult(0x13), string.Format(Properties.Resources.CharacterSetConstraint_Validate_Failed, GetCharSetName()), this));
			}
