...
namespace NerdyDuck.ParameterValidation.Constraints
{
	...
	public class RegexConstraint : Constraint
	{
			...
			: base(RegexConstraintName)
		{
			...
			{
				throw new CodedArgumentNullException(Errors.CreateHResult(0x3a), nameof(regularExpression));
			}
			...
			{
				throw new CodedArgumentException(Errors.CreateHResult(0x3c), nameof(regularExpression), Properties.Resources.RegexConstraint_PatternInvalid, ex);
			}
		}
		...
		protected override void OnValidation(IList<ParameterValidationResult> results, object value, ParameterDataType dataType, string memberName, string displayName)
		{
			...
			{
				results.Add(new ParameterValidationResult(Errors.CreateHResult(0x40), string.Format(Properties.Resources.RegexConstraint_Validate_Failed, mRegularExpression), this));
			}
		}
		#endregion
		#endregion
