#region Copyright
/*******************************************************************************
 * <copyright file="EndpointConstraint.cs" owner="Daniel Kopp">
 ...
 * </assembly>
 * <file name="EndpointConstraint.cs" date="2015-09-30">
 * A constraint specifying that a string is a valid IP end point, e.g. an IPv4 or
 * IPv6 address, a domain name, or a local machine name, with or without a port
 * number.
 * </file>
 ******************************************************************************/
#endregion
...
namespace NerdyDuck.ParameterValidation.Constraints
{
	...
	public class EndpointConstraint : Constraint
	{
		...
		protected EndpointConstraint(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			: base(info, context)
		{
		}
#endif
		...
		protected override void OnValidation(IList<ParameterValidationResult> results, object value, ParameterDataType dataType, string memberName, string displayName)
		{
			...
			{
				results.Add(new ParameterValidationResult(Errors.CreateHResult(0x87), Properties.Resources.Global_Validate_StringEmpty, this));
			}
			else
			{
				...
				if (ColonPos > -1)
				{
					...
					{
						results.Add(new ParameterValidationResult(Errors.CreateHResult(0x89), string.Format(Properties.Resources.EndpointConstraint_Validate_FailedPort, Temp), this));
					}
				}
				if (Uri.CheckHostName(Temp) == UriHostNameType.Unknown)
				{
					results.Add(new ParameterValidationResult(Errors.CreateHResult(0x88), string.Format(Properties.Resources.EndpointConstraint_Validate_Failed, Temp), this));
				}
			}
		}
		#endregion
