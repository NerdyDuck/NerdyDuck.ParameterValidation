#region Copyright
/*******************************************************************************
 * <copyright file="HostnameConstraint.cs" owner="Daniel Kopp">
 ...
 * </assembly>
 * <file name="HostnameConstraint.cs" date="2015-09-30">
 * A constraint specifying that a string is a valid host name, e.g. an IPv4 or
 * IPv6 address, a domain name, or a local machine name.
 * </file>
 ******************************************************************************/
#endregion
...
{
	/// <summary>
	/// A constraint specifying that a string is a valid host name, e.g. an IPv4 or IPv6 address, a domain name, or a local machine name.
	/// </summary>
	/// <remarks>
	/// <para>
	/// <list type="bullet">
	/// <item>The textual representation of the constraint is <c>[Host]</c>.</item>
	/// <item>The constraint is only applicable to the <see cref="ParameterDataType.String"/> data type.</item>
	/// <item>If a string parameter with that constraint is empty or contains characters invalid for a hostname, or an invalid IP address (checked by <see cref="Uri.CheckHostName(string)"/>), a <see cref="ParameterValidationResult"/> is added to the output of <see cref="Constraint.Validate(object, ParameterDataType, string, string)"/>.</item>
	/// </list>
	/// </para>
	/// </remarks>
#if WINDOWS_DESKTOP
	[System.Serializable]
#endif
	public class HostnameConstraint : Constraint
	{
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="HostnameConstraint"/> class.
		/// </summary>
		public HostnameConstraint()
			: base(HostnameConstraintName)
		{
		}

#if WINDOWS_DESKTOP
		/// <summary>
		/// Initializes a new instance of the <see cref="HostnameConstraint"/> class with serialized data.
		/// </summary>
		...
		protected HostnameConstraint(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
			: base(info, context)
		{
		}
#endif
		...
		protected override void OnValidation(IList<ParameterValidationResult> results, object value, ParameterDataType dataType, string memberName, string displayName)
		{
			...
			{
				results.Add(new ParameterValidationResult(Errors.CreateHResult(0x85), Properties.Resources.Global_Validate_StringEmpty, this));
			}
			else if (Uri.CheckHostName(Temp) == UriHostNameType.Unknown)
			{
				results.Add(new ParameterValidationResult(Errors.CreateHResult(0x86), string.Format(Properties.Resources.HostnameConstraint_Validate_Failed, Temp), this));
			}
		}
		#endregion
		#endregion
