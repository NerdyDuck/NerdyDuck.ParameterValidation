...
namespace NerdyDuck.ParameterValidation
{
	...
	public class ConstraintAttribute : ValidationAttribute
	{
			...
			: base()
		{
			...
			{
				throw new CodedArgumentNullException(Errors.CreateHResult(0x97), nameof(constraints));
			}
		...
		{
			IEnumerable<ParameterValidationResult> Results = Validator.Validate(value, mDataType, ParsedConstraints, validationContext.MemberName, validationContext.DisplayName);
